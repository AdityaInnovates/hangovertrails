    ...
    >
      <section className="rounded-3xl border border-line bg-surface p-5 shadow-soft">
        <form className="grid gap-3 md:grid-cols-5">
          ...
          <button
            className="rounded-full bg-forest px-5 py-3 text-sm font-bold text-white"
            type="submit"
          >
            Apply
          </button>
                  ...
                  <tr key={booking.id}>
                    <td className="px-5 py-5">
                      ...
                      <p className="mt-1 text-xs text-stone">
                        {booking.group?.groupBookingCode ?? booking.bookingType}
                      </p>
                    </td>
                    <td className="px-5 py-5">
                    ...
                    <td className="px-5 py-5">
                      <p className="font-bold">
                        {formatMoney(booking.bookingAmountCents)}
                      </p>
                    ...
                    <td className="px-5 py-5">
                      <a
                        href={`/api/admin/bookings/${booking.id}/aadhaar`}
                        target="_blank"
                        className="rounded-full bg-background px-4 py-2 text-xs font-bold text-foreground ring-1 ring-line"
                        rel="noreferrer"
                      >
                        View Aadhaar
                      </a>
